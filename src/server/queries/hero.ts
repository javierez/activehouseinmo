...
export const getHeroProps = (): HeroProps | null => {
  return {
  "title": "Activamos tu gestión inmobiliaria.",
  "subtitle": "Inmobiliaria de la costa mediterránea especializada en la compraventa y el alquiler de viviendas en La Ràpita, Santa Bàrbara y el Montsià.",

...
export async function generateMetadata(): Promise<Metadata> {
  const [seoConfig, logoUrl] = await Promise.all([getSEOConfig(), getLogo()]);
...
export default async function RootLayout({
  ...
  const [logoUrl, socialLinks, contactProps, accountInfo, colorProps, fontProps, features, aboutProps, seoConfig] = await Promise.all([
    getLogo(),
    getSocialLinks(),
    getContactProps(),
